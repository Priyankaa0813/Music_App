...
public class MasterSignUp extends Master 
{
	...
	protected void onCreate(Bundle savedInstanceState) 
	{
		...
		setContentView(R.layout.mastersignup);
	     ...
	     submit.setOnClickListener(new OnClickListener() {
			...
			try
			{
			 DatabaseHub dbh=new DatabaseHub(MasterSignUp.this);
			 SQLiteDatabase db=dbh.getWritableDatabase();
			 ContentValues cv=new ContentValues();
			 cv.put(DatabaseHub.username,name);
			 cv.put(DatabaseHub.password,pass);
			 cv.put(DatabaseHub.college, college);
			 cv.put(DatabaseHub.mail,mail);
			 cv.put(DatabaseHub.address,add);
			 cv.put(DatabaseHub.contact,contact);
			 
			 db.insert(DatabaseHub.masterdb, null, cv);
			 Toast.makeText(MasterSignUp.this,"Register Successfull",Toast.LENGTH_SHORT).show();
			 Intent in=new Intent(MasterSignUp.this,Master.class);
			 startActivity(in);
			}catch(Exception e)
			{
